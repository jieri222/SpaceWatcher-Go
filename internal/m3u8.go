...
func GetStreamURL(ctx context.Context, client *Client, mediaKey string) (string, error) {
...
func ParseM3U8(ctx context.Context, client *Client, m3u8URL string) (*Playlist, error) {
